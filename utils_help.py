...
def auto_resume_helper(output_dir: str) -> Optional[str]:
    """Find the latest checkpoint file in output directory.

    Args:
        output_dir: Directory to search for checkpoint files

    Returns:
        Optional[str]: Path to latest checkpoint file or None if not found
    """
